...
import LandingpageMockUp from "../assets/img/Figma_illustrations/LandingpageMockUp.png";
import MultipageMockUp from "../assets/img/Figma_illustrations/MultipageMockUp.png";
    ...
    <section id="services">
      <div id="services-wrapper">
        ...
        <div id="service-wrapper">
          <div className="service landingpage">
            ...
            <div className="service-img">
              <img src={LandingpageMockUp} alt="Landing Page Mockup" />
            </div>
          </div>
          <div className="service multipage">
            <div className="service-text">
              <h3>Nettside med flere sider</h3>
              <p>
                Ønsker du å vise frem flere tjenester? Vi lager en nettside for
                deg som ønsker å vise frem flere tjenester. En nettside med
                flere sider gjør dine tjenester mer profersjonelle og mer synlig
                på nett.
              </p>
              <br />
            ...
            <div className="service-img">
              <img src={MultipageMockUp} alt="Multipage Mockup" />
            </div>
          </div>
        </div>
